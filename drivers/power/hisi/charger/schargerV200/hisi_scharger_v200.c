...
static void hi6522_config_opt_param(void)
{
	...
	{
		SCHARGER_ERR("wled_ovp_hi6522_device_info is NULL!\n");
		return;
	}
	switch(g_hi6522_dev->wled_ovp_vol)
		{
		case VOL_960:
			hi6522_write_mask(WLED_OVP_REG,WLED_OVP_MASK << WLED_OVP_SHIFT,WLED_OVP_SHIFT,VOL_960);
			break;
		case VOL_1000:
			hi6522_write_mask(WLED_OVP_REG,WLED_OVP_MASK << WLED_OVP_SHIFT,WLED_OVP_SHIFT,VOL_1000);
			break;
		case VOL_900:
			hi6522_write_mask(WLED_OVP_REG,WLED_OVP_MASK << WLED_OVP_SHIFT,WLED_OVP_SHIFT,VOL_900);
			break;
		case VOL_880:
			hi6522_write_mask(WLED_OVP_REG,WLED_OVP_MASK << WLED_OVP_SHIFT,WLED_OVP_SHIFT,VOL_880);
			break;
		default:
			break;
		}
