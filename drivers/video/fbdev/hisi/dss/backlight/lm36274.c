...
void blkit_force_resume_reg_proc(void)
{
	ssize_t error = -1;
	...
	if (g_force_resume_bl_flag == RESUME_2_SINK) {
		LM36274_INFO("blkit_force_resume_reg_proc:RESUME_LINK \n");
		...
		LM36274_INFO("blkit_force_resume_reg_proc:RESUME_REMP_OVP_OCP \n");
		error = lm36274_config_write(lm36274_g_chip,
...
ssize_t blkit_set_normal_work_mode(void)
{
    ...
    LM36274_INFO("blkit_set_normal_work_mode:locked sem succsess \n");
    ...
    up(&(lm36274_g_chip->test_sem));
    LM36274_INFO("blkit_set_normal_work_mode set reg success!\n");
    return error;
...
ssize_t blkit_set_enhance_work_mode(void)
{
    ...
    LM36274_INFO("blkit_set_enhance_work_mode:locked sem succsess \n");
    ...
    up(&(lm36274_g_chip->test_sem));
    LM36274_INFO("blkit_set_enhance_work_mode set reg success!\n");
    return error;
