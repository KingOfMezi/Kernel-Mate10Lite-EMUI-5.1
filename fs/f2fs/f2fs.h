...
struct f2fs_sb_info {
	...
	/* for ssr */
	struct mutex ssr_mutex;			/* mutex for ssr statistics */
	unsigned long last_ssr_jiffies;
	unsigned long curr_node_cnt;
	unsigned long last_node_cnt;
	unsigned long curr_data_cnt;
	unsigned long last_data_cnt;
